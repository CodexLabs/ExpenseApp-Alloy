function loginOnload() {
    ...
    if (httpClient.responseText) {
        ...
        message: "Your username and password combination was wrong"
    });
}
...
var httpClient = Titanium.Network.createHTTPClient(), baseUrl = "http://kulcapexpenseapp.appspot.com/resources/userService/", loginUrl = "login", logoutUrl = "logout", getEmployeeUrl = "getEmployee", token;
